...
class DEAPOptimisationCMA(bluepyopt.optimisations.Optimisation):
    ...
    def __init__(self,
        ...
        for r, m in zip(bounds_radius, bounds_mean):
            self.to_norm.append(partial(lambda x, bm, br: (x - bm) / br, bm=m, br=r))
            self.to_space.append(partial(lambda x, bm, br: (x * br) + bm, bm=m, br=r))
    ...
    def run_cma(self,
        ...
        sigma = 2. / 5.  # 1/5th of the domain width
        logger.info("Global sigma set to: {}".format(sigma))
