...
def test_MetaListEqualParameter_init():
    ...
    sub_params = [
        bluepyopt.parameters.Parameter(name="sub1", value=1),
        bluepyopt.parameters.Parameter(name="sub2", value=2),
    ]
...
def test_MetaListEqualParamete_str():
    ...
    nt.assert_equal(
        str(param),
        "param (sub_params: sub1: value = None,sub2: value = None): " "value = None",
    )
    ...
    nt.assert_equal(
        str(param),
        "param (sub_params: sub1: value = 5.5,sub2: value = 5.5): " "value = 5.5",
    )
