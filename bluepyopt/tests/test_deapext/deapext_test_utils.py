...
def make_mock_population(features_count=5, population_count=5):
    '''Create population of Individuals w/ class that we have full control over,
    creating a DEAP one
    '''
    ...
    #create individuals w/ a random weight values, and an ibea_fitness according to their position
    return [Individual(np.random.normal(MU, SIGMA, features_count), bool(i % 2), i)
